...
class AppStateSpec:
    ...
    VARS = {
        ...
        "audiotrace_visible": (bool, True, True),
        "spectrogram_visible": (bool, True, True),
        "ephys_visible": (bool, True, True),
        "featureplot_visible": (bool, True, True),
        "video_viewer_visible": (bool, True, True),
        "pose_markers_visible": (bool, True, True),
        "labels_visible": (bool, True, True),
        "feature_view_mode": (str, "LinePlot", True),
